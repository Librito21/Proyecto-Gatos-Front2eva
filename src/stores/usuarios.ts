...
export const useusuariosStore = defineStore('usuarios', () => {
    ...
    async function updateUsuario(usuario: UserDto) {
        try {
            ...
            const response = await fetch(`https://adoptaragonapi.retocsv.es/api/Usuario/${usuario.id_Usuario}`, {
                method: "PUT",
    ...
    async function deleteUsuario(id_Usuario: number) {
        ...
        try {
            ...
            const response = await fetch(`https://adoptaragonapi.retocsv.es/api/Usuario/${id_Usuario}`, {
                method: "DELETE",
            });
